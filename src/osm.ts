...
export const catOf = (t: Record<string, string>): Cat | undefined =>
  ...
  : ['station', 'halt', 'tram_stop'].includes(t.railway) ? 'station' : undefined;
