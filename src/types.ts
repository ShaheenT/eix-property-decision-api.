...
export interface Listing {
  url: string; status?: 'under_offer'; listingNumber?: string; listedDate?: string; streetAddress?: string; agency?: string; agentName?: string; receptionRooms?: number; pois?: { category: string; name: string; distanceKm: number }[]; portalCalc?: { monthly?: number; onceOff?: number; minIncome?: number }; recentSales?: { address: string; url?: string }[]; signals?: import('./signals.js').Signal[]; claims?: import('./signals.js').Claims; listing?: 'sale' | 'rental'; rent?: number; lat?: number; lng?: number; image?: string; city?: string; title?: string; suburb?: string; propertyType?: string;
