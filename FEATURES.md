...
Status tags: **[T]** covered by an automated test (`npm test`, 100 scenarios) · **[S]** rule or fact checked against a source in research · **[H]** my default or heuristic, tunable, not validated against real outcomes · **[U]** not tested live or not built.
